...
public class Account {
	 ...
	 *
	 */
	public Account(String accountNumber) throws MalformedHandlerException {
	...
	// int i = 0;
	// while (i < this.titulars.size() && !found) {
	// if (this.titulars.get(i++).getId().compareTo(id.toString()) == 0) {
	...
	// int i = 0;
	// while (i < this.authorizeds.size() && !found) {
	// if (this.authorizeds.get(i++).getId().compareTo(id.toString()) == 0) {
	...
	// */
	// public synchronized void doDirectDebit(DirectDebitTransaction
	// transaction)
	// throws TransactionException {
	...
	// if (this.liquidationStrategies.get(i++).getID()
	// .compareTo(strategy.getID()) == 0) {
	// found = true;
	// }
	// }
	// if (!found) {
